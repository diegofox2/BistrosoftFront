...
import CreateCustomerForm from "@modules/customers/components/CreateCustomerForm.vue";
import CustomerLookup from "@modules/customers/components/CustomerLookup.vue";
import CreateOrderForm from "@modules/orders/components/CreateOrderForm.vue";
import OrderStatusForm from "@modules/orders/components/OrderStatusForm.vue";
          ...
          <div class="mt-4 space-y-2">
            ...
            >
              ...
              <span
                class="mt-2 block text-xs font-normal"
                :class="
                  activePanel === 'orders' ? 'text-white/80' : 'text-slate-500'
                "
                >Create + status</span
              >
            </button>
