...
import { getOrderStatusLabel } from '@modules/orders/constants/orderStatus'
...
export const useActivityStore = defineStore('activity', {
  ...
  actions: {
    ...
    setLastOrder(id: string, status: number, totalAmount: number) {
      this.lastOrder = {
        id,
        label: 'Order created',
    ...
    setLastStatusUpdate(id: string, status: number) {
